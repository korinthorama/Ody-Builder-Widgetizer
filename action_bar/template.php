...
$_container_style = 'padding-bottom: 20px;';
if (!$_full_width) {
...
<section
  ...
  class="widget widget-action-bar widget-<?php echo $_widget_class; ?> <?php echo $_color; ?>"
  ...
  <div class="widget-container widget-container-padded" style="<?php echo $_container_style; ?>">
    <div class="action-bar-inner">
      <div class="action-bar-content">
        ...
        <?php endif; ?>
        <?php if ($_body !== ''): ?>
        <div class="w-body w-rte t-base t-muted" data-setting="text"><p><?php echo htmlspecialchars($_body); ?></p></div>
        <?php endif; ?>
      </div>
