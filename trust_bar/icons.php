    ...
    <script>
        ...
        function saveIcon(icon_class) {
            if (parent_icon_elm.length) {
                ...
                var preview_id = target_id.replace('wdg_trbr_icon_', 'wdg_trbr_icon_preview_');
                var $preview = parent.$('#' + preview_id);
                if ($preview.length) {
                    $preview.removeClass().addClass('fa ' + icon_class + ' wdg-trbr-icon-preview').css('visibility', 'visible');
                }
            }
