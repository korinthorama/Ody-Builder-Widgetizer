    ...
    jQuery(function ($) {
        ...
        function addItem(data) {
            ...
            var $imgWrap = $('<div class="ody_builder_parameter">' +
                ...
                '<br>' +
                '<a href="<?php echo "ody_builder_mediabank.php?blockType=widgetizer&langID=$langID"; ?>" id="' + imgMediaId + '" class="wdg-icg-select-media ody_builder_content_action btn btn-success" data-vbtype="iframe" style="margin-top:6px;"><?php echo t("Επιλογή εικόνας"); ?></a> ' +
