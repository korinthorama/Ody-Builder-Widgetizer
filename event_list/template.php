...
>
  <style>
    ...
    .widget-<?php echo $_widget_class; ?> .widget-card { gap: var(--space-lg); }
    ...
    .widget-<?php echo $_widget_class; ?> .event-date-month { margin-block-start: var(--space-xs); }
    ...
    @media (min-width: 750px) {
      .widget-<?php echo $_widget_class; ?> .widget-card { flex-direction: row; gap: var(--space-2xl); padding: var(--space-2xl); }
      .widget-<?php echo $_widget_class; ?> .event-date { width: 100px; height: 100px; }
    }
  </style>
